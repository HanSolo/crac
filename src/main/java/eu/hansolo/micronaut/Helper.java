...
public class Helper {
    private static final List<Name> allNames = new ArrayList<>();

    public static final List<Name> getRandomNames(final int amount, final Gender gender) {
        final List<Name> allNames = getAllNames();
    ...
    public static final List<Name> getAllNames() {
        if (allNames.isEmpty()) { allNames.addAll(loadNames()); }
        return allNames;
    }

    private static List<Name> loadNames() {
